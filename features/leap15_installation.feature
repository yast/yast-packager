Feature: Test the openSUSE Leap 15.0 installation
  ...
  Scenario: Simple minimal installation
    ...
    Given I attach to the application running at "hostname" port "14155"
    ...
    And the combo box "Region" should have value "USA"
    And the combo box "Time Zone" should have value "Eastern (New York)"
