...
module Yast
  class SourceDialogsClass < Module
    ...
    def RepoNameValidate(_key, event)
      event = deep_copy(event)
    ...
    def PlainURLValidate(_key, event)
      event = deep_copy(event)
